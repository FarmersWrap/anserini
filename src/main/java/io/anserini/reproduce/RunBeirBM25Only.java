...
/**
 * Runner for BEIR BM25-only experiments.
 * 
 * Output files: runs/run.beir-bm25-only.flat.{corpus}.txt
 */
public class RunBeirBM25Only {
  ...
  public static void main(String[] args) throws Exception {
    ...
    RunRepro repro = new RunRepro("beir-bm25-only", new BeirBM25OnlyMetricDefinitions(), 
        beirArgs.printCommands, beirArgs.dryRun, beirArgs.computeIndexSize);
    repro.run();
  }

  public static class BeirBM25OnlyMetricDefinitions extends TrecEvalMetricDefinitions {
    public BeirBM25OnlyMetricDefinitions() {
      super();
      ...
      metricDefinitions.put("beir-bm25-only", beir);
    }
  }
}
