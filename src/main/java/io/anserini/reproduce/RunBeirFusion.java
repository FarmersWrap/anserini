...
/**
 * Runner for BEIR fusion experiments combining BM25 and dense retrieval.
 * This class runs BM25 and BGE searches followed by fusion methods (RRF, Average, Interpolation).
 */
public class RunBeirFusion {
  ...
  public static void main(String[] args) throws Exception {
    ...
    RunRepro repro = new RunRepro("beir-fusion", new BeirFusionMetricDefinitions(), 
        beirArgs.printCommands, beirArgs.dryRun, beirArgs.computeIndexSize);
    repro.run();
  }

  public static class BeirFusionMetricDefinitions extends TrecEvalMetricDefinitions {
    public BeirFusionMetricDefinitions() {
      super();
      Map<String, Map<String, String>> beir = new HashMap<>();
      
      // All BEIR corpora test sets
      String[] corpora = {
      ...
      metricDefinitions.put("beir-fusion", beir);
    }
  }
}
