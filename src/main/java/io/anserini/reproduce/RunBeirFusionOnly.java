...
/**
 * Runner for BEIR fusion-only experiments.
 * Assumes BM25 and BGE run files already exist in runs/ directory.
 * Only runs fusion methods (RRF, Average, Interpolation).
 */
public class RunBeirFusionOnly {
  ...
  public static void main(String[] args) throws Exception {
    ...
    RunRepro repro = new RunRepro("beir-fusion-only", new BeirFusionOnlyMetricDefinitions(), 
        beirArgs.printCommands, beirArgs.dryRun, beirArgs.computeIndexSize);
    repro.run();
  }

  public static class BeirFusionOnlyMetricDefinitions extends TrecEvalMetricDefinitions {
    public BeirFusionOnlyMetricDefinitions() {
      super();
      ...
      metricDefinitions.put("beir-fusion-only", beir);
    }
  }
}
